...
By right-clicking on any modulation source, there will be an option to clear a particular linked parameter,
...
## Modulators
Surge has three main types of modulation sources :
...
### LFOs and internal modulation sources
...
Surge has a total of 14 internal modulation sources:
 - 6 configurable Voice LFO sources (labeled LFO 1-6 for instance)
 - 6 configurable Scene LFO sources (labeled S-LFO 1-6 for instance)
 - "Randomize" modulation source (see [Random modulation source](#random-modulation-source))
 - "Alternate" modulation source (see [Alternate modulation source](#alternate-modulation-source))
...
To open this MSEG editing window, you can either click on the little pencil button next to the wave display,
click on the wave display itself, or double-click on the MSEG icon in the modulation type selector:
